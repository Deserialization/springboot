...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="helloService" class="com.zs.springboot.service.HelloService"></bean>
</beans>
```
...
<form>
    ...
    <div class="form-group">
        <label>Email</label>
        <input type="email" class="form-control" placeholder="zhangsan@zs.com">
    </div>
    <div class="form-group">
...
-->
    ...
    <div class="form-group">
        <label>Email</label>
        <input name="email" type="email" class="form-control" placeholder="zhangsan@zs.com" th:value="${emp!=null}?${emp.email}">
    </div>
    <div class="form-group">
        <label>Gender</label><br/>
        <div class="form-check form-check-inline">
...
@MapperScan(value = "com.zs.springboot.mapper")
@SpringBootApplication
...
com.zs.springboot.listener.HelloApplicationContextInitializer

org.springframework.boot.SpringApplicationRunListener=\
com.zs.springboot.listener.HelloSpringApplicationRunListener
```
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <groupId>com.zs.starter</groupId>
    <artifactId>zs-spring-boot-starter</artifactId>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>com.zs.starter</groupId>
            <artifactId>zs-spring-boot-starter-autoconfigurer</artifactId>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <name>zs-spring-boot-starter-autoconfigurer</name>
...
```java
package com.zs.starter;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "zs.hello")
...
public class HelloService {
    ...
    public String sayHellzs(String name){
...
### 3、整合redis作为缓存
        Redis 是一个开源（BSD许可）的，内存中的数据结构存储系统，它可以用作数据库、缓存和消息中间件。
            ...
            3、配置redis
            4、测试缓存 
#### 3.1、原理 CacheManager===Cache 缓存组件来实际给缓存中存取数据
            1）、引入redis的starter，容器中保存的是 RedisCacheManager；RedisCacheManager                                
            ```java            
            ...
            3）、默认保存数据 k-v 都是Object；利用序列化保存；如何保存为json(这个是springboot1.5.12)
